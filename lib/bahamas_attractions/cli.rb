class CLI
  ...
  def start_selection
    input = ""
      ...
      if (1..30).include?(input.to_i)  #this is where i tell it to grab one attraction and open the page that #prints single choice
        ...
        Attractions.print_all_attractions
      elsif input != "exit"
